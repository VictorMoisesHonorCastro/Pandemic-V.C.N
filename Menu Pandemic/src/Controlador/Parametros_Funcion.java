...
public class Parametros_Funcion {
    ...
    public Parametros_Funcion(int dificultad)  {
        if (dificultad==1){
        ruta_archivo="C:\\Users\\honor\\Desktop\\Menu Pandemic\\src\\XML\\Facil.xml";
        }   
        else if (dificultad==2){
        ruta_archivo="C:\\Users\\honor\\Desktop\\Menu Pandemic\\src\\XML\\Normal.xml";
        }   
         else if (dificultad==3){
        ruta_archivo="C:\\Users\\honor\\Desktop\\Menu Pandemic\\src\\XML\\Dificil.xml";
        }   
