...
public class Nueva_Partida extends javax.swing.JPanel {
    ...
    static int[] parametrosVar = new int[4];
    ...
    Jugador player = new Jugador("San Francisco", usuario, acciones, porcentajeVerde, porcentajeAzul, porcentajeRojo, porcentajeMorado);
    ...
    public Nueva_Partida(int infecciones_inicio, int infecciones_ronda, int enfermedades_muerte, int brotes_muerte) {
    ...
    public List<Integer> aleatorioInicio(int infecciones_inicio) {
    ...
    public List<Integer> aleatorioRonda(int infecciones_ronda) {
