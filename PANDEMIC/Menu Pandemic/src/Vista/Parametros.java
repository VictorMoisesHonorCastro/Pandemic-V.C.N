...
public class Parametros extends javax.swing.JPanel {
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        Nueva_Partida parametrosPartida = new Nueva_Partida(infecciones_inicio, infecciones_ronda, enfermedades_muerte, brotes_muerte);
        usuario = jTextField1.getText();

        
        JFrame marco = (JFrame) SwingUtilities.getWindowAncestor(this);
        marco.remove(this);
        marco.add(new Nueva_Partida(infecciones_inicio, infecciones_ronda, enfermedades_muerte, brotes_muerte));
